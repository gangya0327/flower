<template>
  <div class="app-container">
    ...
    <el-card class="operate-container" shadow="never">
      ...
      <span>数据列表</span>
      <el-button class="btn-add" @click="handleAddFlight()" size="mini">添加</el-button>
      ...
      <el-button
        ...
        size="mini"
      >更新产品数据</el-button>
      <el-button class="btn-add el-button--primary" style="float: right;" @click="handleSyncProduct()" size="mini">批量同步到活动产品列表</el-button>
    </el-card>
    <div class="table-container">
      ...
      >
        ...
        <el-table-column label="机票图片" align="center">
          <template slot-scope="scope">
            <img style="height: 100px" :src="scope.row.pic">
          </template>
        </el-table-column>
        <el-table-column label="机票名称" align="center">
          <template slot-scope="scope">
            <p>{{scope.row.name}}</p>
        ...
        <el-table-column label="操作" width="160" align="center">
          <template slot-scope="scope">
            <p>
              <el-button size="mini" @click="handleUpdateFlight(scope.$index, scope.row)">编辑</el-button>
              <el-button size="mini" type="danger" @click="handleDelete(scope.$index, scope.row)">删除</el-button>
            </p>
            <p>
              <el-button size="mini" @click="handleAddFlightPrice(scope.$index, scope.row)">机票价格管理</el-button>
            </p>
          </template>
        </el-table-column>
      </el-table>
...
const defaultListQuery = {
  ...
  brandId: null,
  businessType: 2 // businessType 业务类型（1-旅游；2-机票；3-酒店；4-文章）
};
export default {
  name: "productList",
  data() {
  ...
  methods: {
    ...
    handleAddFlight() {
      this.$router.push({ path: "/fms/addFlight" });
    },
    handleBatchOperate() {
    ...
    handleUpdateFlight(index, row) {
      this.$router.push({ path: "/fms/updateFlight", query: { id: row.id } });
    },
    // handleAddFlightgroup(index, row) {
    //   this.$router.push({
    //     path: "/fms/addFlightgroup",
    //     query: { fid: row.id }
    //   });
    // },
    handleAddFlightPrice(index, row) {
      this.$router.push({
        path: "/fms/flightprice",
        query: { fid: row.flightId }
      });
    },    
