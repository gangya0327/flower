  ...
  <div style="margin-top: 50px">
    ...
    >
      ...
      <!-- <el-form-item label="航班信息">
        <tinymce :width="550" :height="300" v-model="value.shippingSpace"></tinymce>
      </el-form-item> -->
      <el-form-item label="费用说明">
        <tinymce :width="550" :height="250" v-model="chargeDetailContent"></tinymce>
      </el-form-item>
      <!-- <el-form-item label="行李限额"> 
        <tinymce :width="595" :height="250" v-model="value.baggageAllowance"></tinymce>
      </el-form-item>-->
      <el-form-item label="预订须知">
        <tinymce :width="550" :height="250" v-model="bookTipsContent"></tinymce>
      </el-form-item>
