  ...
  <div class="app-container">
        ...
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          ...
          <el-form-item label="商品类型：">
            <el-select v-model="listQuery.businessType" size="small" style="width: 180px;">
              ...
              <el-option value="4" label="游记产品"></el-option>
    ...
    <div class="table-container">
      <el-table ref="newProductTable"
        ...
        <el-table-column label="推荐理由" align="center">
          <template slot-scope="scope">{{scope.row.note?scope.row.note:"无"}}</template>
        </el-table-column>
