  ...
  <div style="margin-top: 50px">
    ...
    >
      ...
      <!-- <el-form-item label="商品推荐：">
        ...
        <el-switch v-model="value.newStatus" :active-value="1" :inactive-value="0"></el-switch>
        <span style="margin-left: 10px;margin-right: 10px">推荐</span>
        <el-switch v-model="value.recommandStatus" :active-value="1" :inactive-value="0"></el-switch>
      </el-form-item>
      <el-form-item label="服务保证：" v-if="this.isMorefunc">
      ...
      <el-form-item label="选择优惠方式：" v-if="this.isMorefunc">
      ...
      <el-form-item style="text-align: center">
        <el-button size="medium" @click="handlePrev">上一步，填写文章信息</el-button>
        <el-button type="primary" size="medium" @click="handleNext">下一步，填写文章属性</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
