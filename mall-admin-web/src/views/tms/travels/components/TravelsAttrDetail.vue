  ...
  <div style="margin-top: 50px">
    ...
    >
      ...
      <el-form-item label="作者头像">
        <single-upload v-model="value.avtar"></single-upload>
      </el-form-item>
      ...
      <el-form-item label="文章内容：">
        <el-tabs v-model="activeHtmlName" type="card">
          <el-tab-pane label="电脑端详情" name="pc">
            <tinymce :width="595" :height="300" v-model="value.articleDetailHtml"></tinymce>
          </el-tab-pane>
          <el-tab-pane label="移动端详情" name="mobile">
            <tinymce :width="595" :height="300" v-model="value.articleDetailMobileHtml"></tinymce>
          </el-tab-pane>
        </el-tabs>
      </el-form-item>

      <el-form-item style="text-align: center">
        <el-button size="medium" @click="handlePrev">上一步，填写文章促销</el-button>
        <el-button type="primary" size="medium" @click="handleNext">下一步，选择文章关联</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
