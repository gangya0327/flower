  ...
  <div style="margin-top: 50px">
    ...
    >      
     <el-form-item style="margin-bottom:0">
        <span style="color: red;font-size: 12px">（说明：关联专题后，产品将显示在对应专题内）</span>
      </el-form-item>
      ...
      <el-form-item style="margin-bottom:0">
        <span style="color: red;font-size: 12px">（说明：推荐产品展示在文章底部，相关推荐内容中）</span>
      </el-form-item>
...
export default {
  ...
  methods: {
    // 获取所有类别产品
    getAllProductsList() {
      getRelationList(1).then(response => {
