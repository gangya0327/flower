  ...
  <div class="app-container">
      ...
      <div style="margin-top: 15px">
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          <el-form-item label="输入搜索：">
            <el-input style="width: 203px" v-model="listQuery.keyword" placeholder="文章标题"></el-input>
          </el-form-item>
    ...
    <div class="table-container">
      <el-table ref="productTable"
        ...
        <el-table-column label="文章图片" width="120" align="center">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      handleAddTravels() {
        this.$router.push({path:'/tms/addTravels'});
      },
      handleBatchOperate() {
      ...
      handleUpdateProduct(index,row){
        this.$router.push({path:'/tms/updateTravels',query:{id:row.id}});
      },
