        ...
        <div class="table-container">
            ...
            >
                ...
                <el-table-column label="类型" width="95" align="center">
                    <template slot-scope="scope">{{scope.row | formatBusinessType}}</template>
                </el-table-column>
                <el-table-column label="是否活动" width="95" align="center">
                    <template
                        slot-scope="scope"
                    >{{scope.row.isActivityOrder | formatIsActivityOrder}}</template>
                </el-table-column>
                <el-table-column label="提交时间" width="95" align="center">
                ...
                <el-table-column label="操作" width="200" align="center">
                    <template slot-scope="scope">
                        ...
                        <el-button
                            ...
                            v-show="scope.row.status===0||scope.row.status===1||scope.row.status===2||scope.row.status===3||scope.row.status===6"
                        >关闭订单</el-button>
                        <el-button
                            size="mini"
                            @click="handleDeliveryOrder(scope.$index, scope.row)"
                            v-show="scope.row.status===101"
                        >订单发货</el-button>
                        <el-button
                            size="mini"
                            @click="handleViewLogistics(scope.$index, scope.row)"
                            v-show="scope.row.status===102||scope.row.status===103"
                        >订单跟踪</el-button>
                        <el-button
                            size="mini"
                            type="danger"
    ...
    methods: {
        ...
        getList() {
            ...
            if(this.$route.query.joinId){
                this.listQuery.joinId = this.$route.query.joinId
            }
