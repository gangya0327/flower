    ...
    <div class="table-container">
      ...
      >
        ...
        <el-table-column label="商品名称" align="center">
          <template slot-scope="scope">
            <p>{{scope.row.name}}</p>
            <p>类型：{{scope.row.travelType | travelTypeFilter}}</p>
          </template>
        </el-table-column>
        ...
        <el-table-column label="操作" width="160" align="center">
          <template slot-scope="scope">
            ...
            <p>
              <el-button size="mini" @click="handleOpenGroup(scope.$index, scope.row)">旅游路线开班</el-button>
            </p>
          </template>
        </el-table-column>
      </el-table>
...
export default {
  ...
  filters: {
    ...
    travelTypeFilter(value) {
      const travelTypeStr = ["", "自由行", "跟团游", "周边游"];
      return travelTypeStr[value];
    }    
  },
  methods: {
    ...
    handleOpenGroup(index, row) {
      this.$router.push({ path: "/pms/addGroup", query: { pid: row.id } });
    },
