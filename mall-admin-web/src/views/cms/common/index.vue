<template>
  <div class="app-container">
    ...
    <el-card class="operate-container" shadow="never">
      ...
      <span>数据列表</span>
      <el-button class="btn-add" @click="handleAddCommon()" size="mini">添加</el-button>
    ...
    <div class="table-container">
      ...
      >
        ...
        <el-table-column label="操作" width="160" align="center">
          <template slot-scope="scope">
            <p>
              <el-button size="mini" @click="handleUpdateCommon(scope.$index, scope.row)">编辑</el-button>
...
const defaultListQuery = {
  ...
  brandId: null,
  businessType: 6 // businessType 业务类型（1-旅游；2-机票；3-酒店；4-文章；5-门票；6-普通）
};
export default {
  name: "common",
  data() {
  ...
  methods: {
    ...
    handleAddCommon() {
      this.$router.push({ path: "/cms/addCommon" });
    },
    handleBatchOperate() {
    ...
    handleUpdateCommon(index, row) {
      this.$router.push({ path: "/cms/updateCommon", query: { id: row.id } });
    },
