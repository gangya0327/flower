...
const defaultListQuery = {
  ...
  brandId: null,
  businessType: 5 // businessType 业务类型（1-旅游；2-机票；3-酒店；4-文章；5-门票；6-普通）
};
export default {
  name: "ticket",
  data() {
  ...
  methods: {
    ...
    handleAddCommon() {
      this.$router.push({ path: "/mms/addTicket" });
    },
    handleBatchOperate() {
    ...
    handleUpdateCommon(index, row) {
      this.$router.push({ path: "/mms/updateTicket", query: { id: row.id } });
    },
