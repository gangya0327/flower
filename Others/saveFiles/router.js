...
export const constantRouterMap = [
  ...
  // 专题
  {
    ...
    name: 'topic',
    meta: { title: '专题', icon: 'product' },
    children: [{
      path: 'index',
      name: 'topicIndex',
      component: () => import('@/views/topic/productCate/index'),
      meta: { title: '专题', icon: 'product-cate' }
    },
    {
      path: 'addTopic',
      name: 'addTopic',
      component: () => import('@/views/topic/productCate/add'),
      meta: { title: '添加专题' },
      hidden: true
    },
    {
      path: 'updateTopic',
      name: 'updateTopic',
      component: () => import('@/views/topic/productCate/update'),
      meta: { title: '修改专题' },
      hidden: true
    }]
  },
  {
    ...
    },
    {
      ...
      meta: { title: '目的地分类', icon: 'product-cate' }
    },
    {
      path: 'addProductCate',
      name: 'addProductCate',
  ...
  },
  {
    ...
    children: [{
      ...
      meta: { title: '航线列表', icon: 'product-list' }
    },
    {
      path: 'addFlight',
      name: 'addFlight',
      component: () => import('@/views/fms/flight/add'),
      meta: { title: '添加航线', icon: 'product-add' }
    },
    {
      path: 'updateFlight',
      name: 'updateFlight',
      component: () => import('@/views/fms/flight/update'),
      meta: { title: '修改航线', icon: 'product-add' },
      hidden: true
    },
    {
      path: 'addFlightgroup',
